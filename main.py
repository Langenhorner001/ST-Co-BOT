...
while True:
    ...
    try:
        ...
        _t1 = threading.Thread(target=_stream, args=(proc.stdout, _out_lines, 'OUT'), daemon=True)
        _t2 = threading.Thread(target=_stream, args=(proc.stderr, _err_lines, 'ERR'), daemon=True)
        _t1.start(); _t2.start()
